#!/usr/bin/env python3
"""Generate the 1-bit 10x10 Flipper icon for Gatekeeper from an ASCII bitmap.
...
GLYPHS = {
    # A portcullis: the gate you look through before you go through it.
    # Two posts, two bars, three rails, and an arch over the top.
    "gatekeeper_10px": [
        "..######..",
        ".########.",
        ".#.#..#.#.",
